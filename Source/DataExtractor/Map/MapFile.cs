...
namespace DataExtractor
{
    class MapFile
    {
        ...
        public static bool ConvertADT(CASCLib.CASCHandler cascHandler, string fileName, string mapName, string outputPath, int gx, int gy, bool ignoreDeepWater)
        {
            ChunkedFile adt = new();
        ...
        public static bool ConvertADT(CASCLib.CASCHandler cascHandler, uint fileDataId, string mapName, string outputPath, int gx, int gy, bool ignoreDeepWater)
        {
            ChunkedFile adt = new();
                ...
                if (mcnk.MCLQCount > 8)
                {
                    ...
                    if (lquidChunk != null)
                    {
                        ...
                        if (mcnk.Flags.HasAnyFlag(MCNKFlags.LiquidMagma))
                        {
                            ...
                            LiquidFlags[mcnk.IndexY][mcnk.IndexX] |= (byte)LiquidTypeMask.Magma;            // magma
                        }
